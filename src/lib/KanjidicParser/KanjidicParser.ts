...
import closeTagHandlers from '@/lib/KanjidicParser/handlers/close/index.js';
import openTagHandlers from '@/lib/KanjidicParser/handlers/open/index.js';
import type { Entry } from '@/lib/types/database.js';

export class KanjidicParser {
